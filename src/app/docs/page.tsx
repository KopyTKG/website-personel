export default function Docs() {
 return (
  <div className="flex justify-center min-w-full h-11 md:grid md:grid-cols-2 xl:grid-cols-3 pt-14">
   <div className="text-justify flex flex-col gap-3 bg-black/65 px-3 py-4 max-w-md h-max border rounded-xl">
    ...
    <div className="flex justify-between">
     <p className="text-lg text-lime-400">4.4.2024</p>
     <a href="/docs/gui" className="text-xl text-blue-400 hover:cursor-pointer hover:text-blue-500">
      Read more
     </a>
    </div>
   </div>
