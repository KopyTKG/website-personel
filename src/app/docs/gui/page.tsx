     ...
     <Tooltip>
      <TooltipTrigger asChild>
       <a href="https://nextjs.org/" target="_blank" rel="noreferrer">
        <Image src="/svg/nextjs.svg" alt="nextlogo" width={imgSize} height={imgSize} className="" />
       </a>
      </TooltipTrigger>
     ...
     <Tooltip>
      <TooltipTrigger asChild>
       <a href="https://redis.io/" target="_blank" rel="noreferrer">
        <Image src="/svg/redis.svg" alt="nextlogo" width={imgSize} height={imgSize} className="" />
       </a>
      </TooltipTrigger>
      <TooltipContent className="bg-zinc-700 px-3 py-1 rounded-lg text- font-bold">
       Redis
